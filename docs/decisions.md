...
- 2026-09-14 — Task tracking lives in Plane, project Unfathomed (`UNFAT`), not in the repo. `docs/todo.md` removed; it last existed at commit 6a9d79a. Docs stay in the repo; only the working list moved.
